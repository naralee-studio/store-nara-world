...
export const naraTheme = defineTheme({
  ...
  tokens: {
    ...
    "--color-text-secondary": "var(--color-foreground)",
    "--color-text-disabled": "var(--color-foreground)",
    "--color-text-accent": "var(--color-foreground)",
    "--color-text-red": "var(--color-foreground)",
    "--color-accent": "var(--nara-red)",
    "--color-on-accent": "var(--color-background)",
    "--color-border": "var(--nara-line)",
    "--color-border-emphasized": "var(--nara-red)",
    "--focus-outline-color": "var(--nara-red)",
    "--shadow-low": "none",
  ...
  components: {
    selector: {
      base: {
        ...
        ":hover": { borderColor: "var(--nara-red)" },
      },
    },
    "number-input": {
      base: {
